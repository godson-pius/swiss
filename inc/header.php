    ...
    <nav class="menu-top-logo menu-fixed" data-menu-anima="fade-in">
        <div class="container">
            <div class="menu-brand">
                <a href="#">
                    <img class="logo-default scroll-hide" src="media/white-logo.png" alt="logo" style="width: 170px !important; height: 170px"  />
                    <img class="logo-retina scroll-hide" src="media/white-logo.png" alt="logo" style="width: 170px !important; height: 170px"  />
                    <img class="logo-default scroll-show" src="media/white-logo.png" alt="logo" style="width: 170px !important; height: 170px"  />
                    <img class="logo-retina scroll-show" src="media/white-logo.png" alt="logo" style="width: 170px !important; height: 170px"  />
                </a>
            </div>
            <i class="menu-btn"></i>
            <div class="menu-cnt">
