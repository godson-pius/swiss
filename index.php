    ...
    <section class="section-video section-home-slider light">
            ...
            <div class="container">
                <div class="row align-items-center" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>
                            A trusted company with numerous branches in over 10 countries, having over 5 million 
                            customers as our journey has not ended as we aim to countinue to make impact worldwide, 
                            bringing satisfaction and smiles towards all faces.
                        </p>
                        <hr class="space-sm" />
                        <div class="grid-list boxed-area list-gallery" data-columns="4" data-lightbox-anima="fade-top">
                            <div class="grid-box">
                                ...
                                <div class="grid-item">
                                    <section class="img-box" >
                                        <img src="media/image-11.jpg" alt="">
                                    </section>
                                </div>
                                <div class="grid-item">
                                    <section class="img-box" >
                                        <img src="media/image-12.jpg" alt="">
                                    </section>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section-image light align-center ken-burn-center" data-parallax="scroll" data-image-src="media/hd-2.jpg">
            <div class="container" data-anima="fade-bottom" data-time="1000">
                ...
                <!-- <table class="table table-grid table-border align-center table-logos table-10">
                    <tbody>
                        <tr>
                            <td>
                                <img src="media/logos/white/logo-1.png" alt="" />
                            </td>
                            <td>
                                <img src="media/logos/white/logo-2.png" alt="" />
                            </td>
                            <td>
                                <img src="media/logos/white/logo-3.png" alt="" />
                            </td>
                            <td>
                                <img src="media/logos/white/logo-4.png" alt="" />
                            </td>
                            <td>
                                <img src="media/logos/white/logo-5.png" alt="" />
                            </td>
                            <td>
                                <img src="media/logos/white/logo-6.png" alt="" />
                            </td>
                        </tr>
                    </tbody>
                </table> -->
                        ...
                        <ul class="slider controls-top-right" data-options="type:carousel,arrows:false,nav:true,perView:3,perViewMd:2,perViewXs:1,gap:30,controls:out">
                            <li>
                                <div class="cnt-box cnt-box-testimonials-bubble">
                                    <p>
                                        If you don’t succeed at first, there’s no need for the word failure. Pick yourself up and try again.
                                    </p>
                                    <div class="thumb-bar">
            ...
            <div class="container">
                            ...
                            <td>
                                <div class="counter counter-horizontal counter-icon">
                                    ...
                                    <div>
                                        <h3>Countries</h3>
                                        <div class="value">
                                            <span class="text-md" data-to="19" data-speed="5000">19</span>
                                            <span>+</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="counter counter-horizontal counter-icon">
                                    ...
                                    <div>
                                        <h3>Clients</h3>
                                        <div class="value">
                                            <span class="text-md" data-to="5000000" data-speed="5000">5 000 000</span>
                                            <span>+</span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="counter counter-horizontal counter-icon">
                                    ...
                                    <div>
                                        <h3>Awards</h3>
                                        <div class="value">
                                            <span class="text-md" data-to="5" data-speed="5000">5</span>
                                            <span>+</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-3">
                        ...
                        <p>
                            Meet our wonderful CEOs who drive continually to making your banking experience exceptional.
                        </p>
